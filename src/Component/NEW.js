...
export default function NEW() {
    ...
    let toggle=()=>{
        if(mystyle.backgroundColor==='white'&&chans.backgroundColor==="black")
            {
                setmystyle({ 
                    color:"white" ,
                    backgroundColor:"black"
  ...
  return (
    ...
    <div className='container my-3' style={mystyle}>
        <h1 className='hd mx-2'>About us</h1>
    ...
    <div className="container">
        <button onClick={toggle} type="button"  className="btn btn-dark" style={chans}> {dark}</button>
    </div>
    </>
  )
}
